...
out_dir=parser/model_iss78 # Store log/model files.
...
python -m parser.parser \
    ...
    --morph_embed_file=${morph_embed_file} \
    --word_embed_size=${word_embed_size}    \
    --char_embed_size=${char_embed_size}  \
    --morph_embed_size=${morph_embed_size}  \
